  ...
  <div>
    ...
    >
      <v-list class="pt-4">
        ...
        <!-- <v-list-tile active-class="red--text" to="/services">
          <v-list-tile-content>
            <v-list-tile-title>SERVICES</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile> -->
        <v-list-tile active-class="red--text" to="/portfolio/web">
          <v-list-tile-content>
            <v-list-tile-title>PORTFOLIO</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <!-- <v-list-tile active-class="red--text" to="/blog">
          <v-list-tile-content>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        <span class="font-weight-light"> &#60; Filiberto</span>
        <span class="red--text">Reyes.dev /></span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/resume" active-class="red--text headline"
          >Resume</v-btn
        >
        <!-- <v-btn flat to="/services" active-class="red--text headline"
          >Services</v-btn
        > -->
        <v-btn flat to="/portfolio/web" active-class="red--text headline"
          >Portfolio</v-btn
        >
        <!-- <v-btn flat to="/blog" active-class="red--text headline">Blog</v-btn> -->
        <v-btn flat to="/contact" active-class="red--text headline"
          >Contact</v-btn
        >
