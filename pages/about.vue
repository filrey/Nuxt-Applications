  ...
  <v-layout>
    <v-flex>
      <v-card class="mx-auto" max-width="600" flat>
        <v-img class="white--text" height="200px" :src="banner"> </v-img>
        <v-card-title class="align-end fill-height"
          >About 24 Hr Painting</v-card-title
        >
        <v-card-text>
        ...
        <v-card-text>
          License Holder: fredy navarro <br />
          License Type: C33 - Painting and Decorating (CA) <br />
          License number: #1042217 <br />
        ...
        <div class="text-center">
          <v-dialog v-model="dialog" width="600">
            <template v-slot:activator="{ on }">
              <v-btn class="ma-2" color="red lighten-2" dark v-on="on">
                Our Privacy Policy
              </v-btn>
            </template>
            ...
            <v-card>
              ...
              <v-card-text>
                <p>
                  ...
                  from https://24hrpaintingservices.com/ (the
                  &ldquo;Site&rdquo;).
                </p>
                ...
                <p>
                  ...
                  Additionally, we use this Order Information to:<br />Communicate
                  with you;<br />Screen our orders for potential risk or fraud;
                  and<br />When in line with the preferences you have shared
                  with us, provide you with information or advertising relating
                  to our products or services.<br />We use the Device
                  Information that we collect to help us screen for potential
                  risk and fraud (in particular, your IP address), and more
                  generally to improve and optimize our Site (for example, by
                  generating analytics about how our customers browse and
                ...
                <br />
                <p>
                  24 Hr Painting Services does not sell, rent, or lease any of
                  its customer lists and/or names to any third parties.
                </p>
                <p>
                  24 Hr Painting Services may collect and may make use of
                  ...
                  to you from https://24hrpaintingservices.com/
                </p>
                <p>
                ...
                <p>
                  ...
                  visit the Network Advertising Initiative&rsquo;s
                  (&ldquo;NAI&rdquo;) educational page at
                  http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.
                </p>
                <p>
                  You can opt out of targeted advertising by sending an email
                  request to javierlopezfredy199@gmail.com
                </p>
                ...
                <p>
                  <br />Please note that we do not alter our Site&rsquo;s data
                ...
                <p>
                  <br />When you place an order through the Site, we will
                  maintain your Order Information for our records unless and
                ...
                <p>
                  <br />We may update this privacy policy from time to time in
                ...
                <p>
                  ...
                  please contact us by e-mail at javierlopezfredy199@gmail.com
                  or by mail using the details provided below:
                </p>
                <p>15113 Burton st, Los Angeles, CA, 91402, United States</p>
              </v-card-text>
...
export default {
  data() {
    return {
      banner: require('@/assets/freddy.jpg'),
      dialog: false
    }
  }
}
