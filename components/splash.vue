  ...
  data() {
    return {
      links: [
        {
          name: 'Github',
          icon: '../assets/png/bg3.png',
          url: 'https://github.com/filrey'
        },
        {
          name: 'LinkedIn',
          icon: '',
          url: 'www.linkedin.com/in/filiberto-reyes'
        },
        {
          name: 'Resume',
          icon: '',
...
.cardSlide_right {
  -webkit-animation: slideIn_right 1s; /* Safari 4.0 - 8.0 */
